package com.aisadsa.aisadsabackend.auth.service;

import com.aisadsa.aisadsabackend.auth.entity.User;
import com.aisadsa.aisadsabackend.auth.entity.UserRole;
...
public class AuthService {
    ...
    public AuthResponse login(LoginRequest loginRequest) {
        ...
        var user = userRepository.findByUsername(loginRequest.getEmail()).orElseThrow(() -> new UsernameNotFoundException("User not found!"));
